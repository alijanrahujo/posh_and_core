...
<head>
    ...
    <style>
        ...
        .form-inner, .card, .card-header
        {
            background-color: #767670 !important;
            color: #fff !important;
        }
        .form-group-material > input, .form-control
        {
        ...
        .logo > span, .forgot-pass, .external
        {
            color: #f2d44f !important;
        }
        .btn-primary
        {
            background-color: #f2d44f !important;
            color: black !important;
            border-radius: 10px;
        }
        .btn-primary:hover
        {
            background-color: #cfb541 !important;
        }
    </style>
</head>
<body>
<div class="page login-page">
    <div class="container">
        <div class="site_logo"><img src="<?php echo e(asset('uploads').'/'.$general_setting->site_logo); ?>"></div>
...
unset($__errorArgs, $__bag); ?>"
                               name="username" value="<?php echo e(old('username')); ?>" required autofocus autocomplete="off">
...
<?php /**PATH /home5/neworatec/posh-core.neworatec.com/resources/views/auth/login.blade.php ENDPATH**/ ?>