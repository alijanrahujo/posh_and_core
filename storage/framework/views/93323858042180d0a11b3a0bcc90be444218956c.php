...
<head>
    ...
    <link rel="preload" as="style" onload="this.onload=null;this.rel='stylesheet'" href="<?php echo e(asset('css/my-dark.css')); ?>" id="theme-stylesheet" >
    <noscript><link rel="preload" as="style" onload="this.onload=null;this.rel='stylesheet'" href="<?php echo e(asset('css/my-dark.css')); ?>" id="theme-stylesheet" ></noscript>
    ...
    <script type="text/javascript" src="<?php echo e(asset('js/city.js')); ?>"></script>
                        ...
                        <ul class="right-sidebar">
                            ...
                            <li>
                                <form id="logout-form" action="<?php echo e(route('logout')); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
                                    <button class="btn btn-link logout" type="submit"><i
        ...
        <div class="main-menu">
            <ul id="side-main-menu" class="side-menu list-unstyled">
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view-complaint')): ?>
                    <li class="<?php echo e((request()->is('view-complaint*')) ? 'active' : ''); ?>"><a
                                href="<?php echo e(route('complaints.index')); ?>"> <i
                                    class="dripicons-calendar"></i><span><?php echo e(trans('file.Complaints')); ?></span></a>
                    </li>
                <?php endif; ?>
...
<?php /**PATH C:\laragon\www\Client\CRMm\resources\views/layout/main.blade.php ENDPATH**/ ?>