...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/my-dark.css')); ?>" id="theme-stylesheet"
          type="text/css">
    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-holder d-flex align-items-center justify-content-between">
                ...
                <span class="brand-big" id="site_logo_main"><?php if($general_settings->site_logo ?? "no"): ?>
                        ...
                        <ul class="right-sidebar">
                            ...
                            <li>
                                <form id="logout-form" action="<?php echo e(route('logout')); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
                                    <button class="btn btn-link logout" type="submit"><i class="dripicons-exit"></i> <?php echo e(trans('file.logout')); ?></button>
                                </form>
                            </li>
                        </ul>
                    </li>
...
</html><?php /**PATH /home5/neworatec/posh-core.neworatec.com/resources/views/layout/client.blade.php ENDPATH**/ ?>