        ...
        $(document).on('click', '.edit', function () {
            ...
            $.ajax({
                ...
                success: function (html) {
                    ...
                    $('#role_users_id').selectpicker('val', html.data.role_users_id);
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Client\CRMm\resources\views/all_user/index.blade.php ENDPATH**/ ?>