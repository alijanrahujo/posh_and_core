...
<head>
    ...
    <link rel="preload" as="style" onload="this.onload=null;this.rel='stylesheet'" href="{{ asset('css/my-dark.css') }}" id="theme-stylesheet" >
    <noscript><link rel="preload" as="style" onload="this.onload=null;this.rel='stylesheet'" href="{{ asset('css/my-dark.css') }}" id="theme-stylesheet" ></noscript>
    ...
    <div class="side-navbar-wrapper">
        ...
        <div class="main-menu">
            <ul id="side-main-menu" class="side-menu list-unstyled">
                ...
                @can('view-complaint')
                    <li class="{{ (request()->is('view-complaint*')) ? 'active' : '' }}"><a
                                href="{{route('complaints.index')}}"> <i
                                    class="dripicons-calendar"></i><span>{{trans('file.Complaints')}}</span></a>
                    </li>
                @endcan
