...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/my-dark.css') }}" id="theme-stylesheet"
          type="text/css">
    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-holder d-flex align-items-center justify-content-between">
                ...
                <span class="brand-big" id="site_logo_main">@if($general_settings->site_logo ?? "no")
                        ...
                        <ul class="right-sidebar">
                            ...
                            <li>
                                <form id="logout-form" action="{{ route('logout') }}" method="POST">
                                    @csrf
                                    <button class="btn btn-link logout" type="submit"><i class="dripicons-exit"></i> {{trans('file.logout')}}</button>
                                </form>
                            </li>
                        </ul>
                    </li>
